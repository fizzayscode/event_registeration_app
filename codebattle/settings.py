...
SECRET_KEY = 'django-insecure-%mfr)#zq5ssiikkuhg(%ov4z+iq0($=wvfuylm(k=d-uxqdar#'
...
#let django know we have a custom user model we want to use not the defualt one
...
# TELLS DJANGO TO FIND MY IMAGES HERE JUST LIKE CLICKING TWITTER PHOTO TO
